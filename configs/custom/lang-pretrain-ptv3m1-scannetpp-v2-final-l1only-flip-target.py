...
# 2026-08-04 REBUTTAL T2-2: 训练目标符号翻转（全场景同一固定 seed 随机 +/-1 向量，
# 等价基扰动）。与 final-l1only 唯一差异 = global_sign_path -> flip sidecar。
...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-final-l1only-flip-target"
