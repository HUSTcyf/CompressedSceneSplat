...
empty_cache = False  # ENABLED to free memory between iterations and reduce OOM
enable_amp = False  # Re-enabled for memory efficiency, using gradient clipping to prevent NaN
evaluate = False
