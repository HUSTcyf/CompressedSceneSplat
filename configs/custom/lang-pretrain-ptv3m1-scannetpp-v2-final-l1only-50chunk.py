...
# ============================================================================
epoch = 1  # 50-chunk 配方：1 epoch = 每 chunk 100 遍  # 2026-08-04：用户时间限制，20→10
eval_epoch = 1
...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-final-l1only-50chunk"
...
data = dict(
    ...
    train=dict(
        ...
        loop=100,  # 2026-08-04 50-chunk 配方：每 chunk 迭代 100 遍（50x100=5000）
