...
# 2026-08-04 REBUTTAL T2-3: 训练目标乘固定随机正交矩阵（等价基扰动）。
# 与 final-l1only 唯一差异 = 新增 target_rotate_matrix_path。
...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-final-l1only-rotate-target"
...
data = dict(
    ...
    train=dict(
        ...
        svd_rank=16,
        svd_center=False,
        # 2026-08-04 REBUTTAL T2-3：训练目标乘固定随机正交矩阵（canonicalize/global_signs 之后应用）
