...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-final-l1only-50chunk-flip-target"
...
data = dict(
    ...
    train=dict(
        ...
        global_sign_path="/home/isom/cyf/SceneSplat/scannetpp_v2/lang_feat_grid_svd_r16_flip_signs.npz",
        transform=[
