"""
Config file for training LitePT on ScanNet 3DGS data.

Usage:
    python tools/train_lite.py --config-file configs/scannet/semseg-litept-scannet.py
"""
...
# ============================================================================
# Model settings - LitePT
# ============================================================================
model = dict(
    type="DefaultSegmentorV2",
    num_classes=20,
    backbone_out_channels=64,  # LitePT base channels
    backbone=dict(
        type="LitePT",
        in_channels=14,  # 3DGS features: color(3) + opacity(1) + quat(4) + scale(3) + xyz(3)
