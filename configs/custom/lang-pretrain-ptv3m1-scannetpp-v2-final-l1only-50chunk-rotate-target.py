...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-final-l1only-50chunk-rotate-target"
...
data = dict(
    ...
    train=dict(
        ...
        target_rotate_matrix_path="/home/isom/cyf/SceneSplat/scannetpp_v2/lang_feat_grid_svd_r16_rotate_matrix.npz",
        transform=[
