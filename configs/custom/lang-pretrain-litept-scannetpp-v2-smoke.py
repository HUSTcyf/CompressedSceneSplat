...
# ============================================================================
epoch = 1
eval_epoch = 1  # evaluate and save every 1 epoch
...
save_path = "exp/smoke-lite-16-scannetpp-v2"
...
hooks = [
    ...
    dict(type="CheckpointSaver", save_freq=1),  # save checkpoint every 10 epochs
