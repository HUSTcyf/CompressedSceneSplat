...
svd_rank = 8  # SVD compression rank (same as litept baseline)
...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-final-l1only-50chunk-r8"
...
data = dict(
    ...
    train=dict(
        ...
        global_sign_path="/home/isom/cyf/SceneSplat/scannetpp_v2/lang_feat_grid_svd_r8_global_signs_v3.npz",
        transform=[
