...
save_path = "exp/smoke-ptv3m1-16-scannetpp-v2-noaug-globalsign-v2"
...
data = dict(
    ...
    train=dict(
        ...
        global_sign_path="/home/isom/cyf/SceneSplat/scannetpp_v2/lang_feat_grid_svd_r16_global_signs.npz",
        transform=[
