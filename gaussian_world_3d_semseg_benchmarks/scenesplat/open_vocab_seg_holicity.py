...
def main():
    ...
    if lang_feat_path is None:
        scannet_langfeat_root = os.path.join(gs_root, f"language_features_{model_name}")
    else:
        scannet_langfeat_root = lang_feat_path
    ...
    for scene_id in tqdm(scene_ids, desc="Processing scenes"):
        ...
        gs_path = os.path.join(gs_root, scene_id, "ckpts", "point_cloud_9000.ply")
