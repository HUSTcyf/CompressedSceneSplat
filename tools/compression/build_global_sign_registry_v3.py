...
OUT = "/home/isom/cyf/SceneSplat/scannetpp_v2/lang_feat_grid_svd_r16_global_signs_v3.npz"
N_WORKERS = 16
...
def main():
    ...
    neg = {i: int((signs[:, i] < 0).sum()) for i in range(16)}
    print("per-dim neg counts:", [neg[i] for i in range(16)])
    v2 = os.path.join(os.path.dirname(OUT), "lang_feat_grid_svd_r16_global_signs.npz")
