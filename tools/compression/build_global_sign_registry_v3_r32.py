...
OUT = "/home/isom/cyf/SceneSplat/scannetpp_v2/lang_feat_grid_svd_r32_global_signs_v3.npz"
N_WORKERS = 16
...
def main():
    ...
    v2 = os.path.join(os.path.dirname(OUT), "lang_feat_grid_svd_r32_global_signs.npz")
